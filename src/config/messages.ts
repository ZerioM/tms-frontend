export const SERVER_ERROR = 'An error occurred while connecting to the server.';
export const NO_DATA_FOUND_FOR_FILTERS = 'No Sensor Data found for specified filters.';
...
export const HOME_BUTTON_TITLE = 'Home';
export const IMPRINT_BUTTON_TITLE = 'Impressum';
